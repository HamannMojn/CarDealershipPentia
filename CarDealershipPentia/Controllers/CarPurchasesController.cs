...
namespace CarDealershipPentia.Controllers
{
    public class CarPurchasesController : Controller
    {
        ...
        public CarPurchasesController(DataContext context)
        {
            _context = context;
        }
        ...
        {
            return View(await _context.CarPurchases.ToListAsync());
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var carPurchase = await _context.CarPurchases
        ...
        public async Task<IActionResult> Create([Bind("ID,OrderDate,PricePaid")] CarPurchase carPurchase)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var carPurchase = await _context.CarPurchases.FindAsync(id);
            if (carPurchase == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,OrderDate,PricePaid")] CarPurchase carPurchase)
        {
        ...
        {
            var carPurchase = await _context.CarPurchases.FindAsync(id);
            _context.CarPurchases.Remove(carPurchase);
            await _context.SaveChangesAsync();
            return RedirectToAction(nameof(Index));
        }
        ...
        {
            return _context.CarPurchases.Any(e => e.ID == id);
        }
    }
}
